...
/*   Updated: 2026/05/19 16:03:57 by ftessi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
    ...
    printf("\n Same over n:");
    printf("\n Mine: %d     | Expected: %d\n", ft_memcmp(str1, str2, 22), memcmp(str1, str2, 22));
    
    printf("\n first smaller:");
    printf("\n Mine: %d     | Expected: %d\n", ft_memcmp(str1, str3, 10), memcmp(str1, str3, 10));
    
    printf("\n second smaller:");
    printf("\n Mine: %d     | Expected: %d\n", ft_memcmp(str3, str1, 10), memcmp(str3, str1, 10));

    printf("\n First position:");
    printf("\n Mine: %d     | Expected: %d\n", ft_memcmp(str1, data1, 3), memcmp(str1, data1, 3));

    printf("\n n = 0:");
    printf("\n Mine: %d     | Expected: %d\n", ft_memcmp(str1, str2, 0), memcmp(str1, str2, 0));

    printf("\n Null string:");
    printf("\n Mine: %d     | Expected: %d\n", ft_memcmp(str1, str4, 6), memcmp(str1, str4, 6));

    printf("\n Empty Data array:");
    printf("\n Mine: %d     | Expected: %d\n", ft_memcmp(data1, data2, 6), memcmp(data1, data2, 6));
